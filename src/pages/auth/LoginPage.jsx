...
function LoginPage() {
  ...
  return (
    <div
      className="min-h-screen h-screen w-full flex items-center justify-center bg-white overflow-hidden"
      style={{ minHeight: '100vh' }}
    >
      <div
        className="w-full max-w-md md:max-w-lg px-6 py-8 shadow-xl rounded-2xl bg-white flex flex-col"
        style={{ boxShadow: '0 4px 32px 0 rgba(0,0,0,0.08)' }}
      >
        {/* Logo and Header */}
        <div className="flex flex-col items-center mb-6">
          <img src={wcdLogo} alt="Westwood Logo" className="h-24 w-24 mb-2 object-contain mx-auto" />
          <h1 className="text-3xl font-extrabold text-dark-900 tracking-tight text-center mb-1">WORKS</h1>
          <p className="text-base font-semibold text-yellow-700 text-center mb-1">Westwood Operations &amp; Resource Knowledge System</p>
          <h2 className="text-xl font-bold text-dark-900 text-center mt-1">Welcome back</h2>
          <p className="text-dark-600 mt-1 text-center text-sm">
